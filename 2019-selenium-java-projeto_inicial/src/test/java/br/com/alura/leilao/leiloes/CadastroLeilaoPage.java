...
public class CadastroLeilaoPage extends PageObject{
	...
	public LeiloesPage cadastrarLeilao(String nome, String hoje, String valor) {
		...
		return new LeiloesPage(browser); //retorna para a pagina de leiloes
	}
	...
	public boolean MensagensValidacoesVisiveis() {
